...
def process_image(filename):
    ...
    cv2.putText(final, 'Most Primary Colors in the Image', (rows // 2 - 230, cols // 2 - 40),
...
# GUI setup
root = tk.Tk()
root.title("PRIMARY COLOURS DETECTION IN AN IMAGE")

# Add an image below the upload button
